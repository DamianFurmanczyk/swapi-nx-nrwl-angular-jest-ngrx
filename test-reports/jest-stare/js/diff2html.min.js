!(function r(e, n, t) {
...
})(
  {
        ...
        (global = this),
          (factory = function(exports) {
            ...
            function structuredPatch(
              ...
              void 0 === (options = options || {}).context &&
                (options.context = 4);
            ...
            function conflict(hunk, mine, their) {
              (hunk.conflict = !0),
                hunk.lines.push({ conflict: !0, mine: mine, theirs: their });
            }
            ...
            (arrayDiff.tokenize = function(value) {
              ...
              (exports.convertChangesToDMP = function(changes) {
                for (
                  var change, operation, ret = [], i = 0;
                  i < changes.length;
                  i++
                )
                  (operation = (change = changes[i]).added
                    ? 1
                    : change.removed
                    ? -1
                    : 0),
              ...
              for (var key in item)
                if ('__proto__' !== key) {
                  ...
                  result[key] = recursive
                    ? merge_recursive(result[key], sitem)
                    : sitem;
                }
          }
          return result;
      ...
      function(require, module, exports) {
        ...
        (utils = require('./utils.js').Utils),
          ...
          (DiffParser.prototype.generateDiffJson = function(
            ...
            function saveBlock() {
              currentBlock &&
                (currentFile.blocks.push(currentBlock), (currentBlock = null));
            }
            function saveFile() {
              currentFile &&
            ...
            function startFile() {
              saveBlock(),
                saveFile(),
                (currentFile = { blocks: [], deletedLines: 0, addedLines: 0 });
            }
    ...
    12: [
      ...
      {
        './templates/diff2html-templates.js': 18,
        fs: 1,
        'hogan.js': 4,
        path: 7
      }
    ...
    13: [
      function(require, module, exports) {
        ...
        (LineByLinePrinter = require('./line-by-line-printer.js')
          .LineByLinePrinter),
      ...
      {
        './file-list-printer.js': 11,
        './line-by-line-printer.js': 14,
        './side-by-side-printer.js': 17
      }
    ],
    14: [
      function(require, module, exports) {
                  ...
                  function processChangeBlock() {
                    var matches,
                      ...
                      doMatching =
                        ...
                        maxLineSizeInBlock <
                          that.config.maxLineSizeInBlockForComparison &&
